      ...
      <div class="flex justify-around flex-wrap">
        ...
        <div class="max-w-xs bg-white border border-gray-200 rounded-lg shadow mb-4">
          ...
          <div class="p-4 flex flex-col justify-center items-center">
            ...
            <div class="inline-flex items-center px-3 py-2 text-sm font-medium text-center text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 ">
